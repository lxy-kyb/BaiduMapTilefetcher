...
SLICES_DB_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'slices_r.db')
...
def slice_tiles_z(lng1, lat1, lng2, lat2, z):
    ...
    cur = conn.cursor()
    try:
        sql = 'INSERT INTO slices VALUES (?, ?, ?, 0);'
...
if __name__ == '__main__':
    ...
    '''
    clear_slices()
    slice_tiles(114.467361, 34.127447, 122.985309, 38.125886, 10, 12)
